          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Browse Galleries</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Explore stunning collections of wildlife photography
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text31">Learn About Wildlife</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Discover fascinating facts about various wild animals and
                      their behaviors.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Connect With Nature</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Immerse yourself in the beauty of the animal kingdom and
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      By enjoying these wildlife photographs, you are supporting
                      conservation initiatives to protect endangered species.
                    </span>
                  </Fragment>
                )}
              </span>
