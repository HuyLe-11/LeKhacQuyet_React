      ...
      <div className="pricing14-max-width thq-section-max-width">
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2 className="pricing14-text101 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="pricing14-text204">Pricing plan</span>
                </Fragment>
              )}
            </h2>
        ...
        <div className="pricing14-tabs">
          {isMonthly && (
            ...
            >
              <span className="thq-body-small">For printing</span>
            </button>
          )}
          {!isMonthly && (
            <button
          ...
          {!isMonthly && (
            ...
            >
              <span className="thq-body-small">For copyright</span>
            </button>
          )}
          {isMonthly && (
            <button
            ...
            <div className="pricing14-column1 thq-card">
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text166">$99/month</span>
                      </Fragment>
                    )}
                  </h3>
              ...
              <button className="pricing14-button14 thq-button-outline thq-button-animated">
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing14-text173">Sign Up Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text176">$149/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text157">$1499/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
            ...
            <div className="pricing14-column3 thq-card">
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text170">$1999/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing14-button16 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text171">Explore More</span>
                    </Fragment>
                  )}
                </span>
              </button>
