...
const SignIn10 = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    // Xử lý giả lập: ví dụ kiểm tra tài khoản
  ...
  return (
    <div
      className={`sign-in10-container1 thq-section-padding ${props.rootClassName} `}
    >
          ...
          <div className="sign-in10-form1">
            <div className="sign-in10-container3">
              <h2 className="thq-heading-2 sign-in10-text10">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-in10-text24">Sign In</span>
                  </Fragment>
                )}
              </h2>
            </div>
            <form className="sign-in10-form2" onSubmit={handleSubmit(onSubmit)}>
              <div className="sign-in10-email">
                ...
                <input
                  ...
                  className="sign-in10-textinput1 thq-body-large thq-input"
                  {...register('username')}
                />
              </div>
              <div className="sign-in10-password">
                <div className="sign-in10-textfield">
                  ...
                  <input
                    ...
                    className="sign-in10-textinput2 thq-body-large thq-input"
                    {...register('password')}
                  />
                </div>
                <a
            ...
            >
              <span className="sign-in10-text14 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-in10-text21">Sign In</span>
                  </Fragment>
                )}
              </span>
            </button>
        ...
        <div className="sign-in10-container6 thq-section-padding">
          <div className="sign-in10-container7">
            <h2 className="thq-heading-2">
              {props.heading2 ?? (
                <Fragment>
                  <span className="sign-in10-text25">New to our site?</span>
                </Fragment>
              )}
            </h2>
            <p className="thq-body-large">
              {props.content2 ?? (
                <Fragment>
                  <span className="sign-in10-text23">
          ...
          <button type="submit" className="sign-in10-button4 thq-button-filled">
            <span className="sign-in10-text20 thq-body-small">
              {props.action2 ?? (
                <Fragment>
                  <span className="sign-in10-text22">Create Account</span>
                </Fragment>
              )}
            </span>
          </button>
