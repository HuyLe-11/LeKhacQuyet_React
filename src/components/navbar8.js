      ...
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href='/' class = "navbar8-link11 thq-link thq-body-small">
            <Fragment>
              <span className="navbar8-text18">Home</span>
            </Fragment>
            </a>

            <div class="thq-link thq-body-small">
                <Fragment>
                  <span className="navbar8-text25">Galleries</span>
                </Fragment>
            </div>
            <a
              href='/about'
            ...
            <div className="navbar8-link4-accordion">
                ...
                {link5AccordionOpen && (
                  <div className="navbar8-container5">
                    ...
                    <a href="https://www.instagram.com/quyetphotos/" target='_blank'>
                      <div className="navbar8-menu-item2">
                        <img
                          alt="Le Khac Quyet Instagram"
                          src="/res/Instagram_favicon.png"
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text20">Instagram</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                ...
                                Explore my latest photos and behind-the-scenes
                                </span>
                              </Fragment>
                            )}
                          </span>
                    ...
                    <a href="https://x.com/quyetkhacle" target='_blank'>
                      <div className="navbar8-menu-item3">
                        <img
                          src="/res/x_favicon.webp"
                    ...
                    <a href="https://mail.google.com/mail/u/0/#search/quyet2004%40gmail.com" target='_blank'>
                      <div className="navbar8-menu-item4">
                        <img
                          src="/res/email favicon.png"
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text26">Booking information</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text17">Login</span>
                  </Fragment>
                )}
              </span>
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="navbar8-mobile-menu">
              ...
              <div className="navbar8-link4-accordion">
                ...
                {link5AccordionOpen && (
                  <div className="navbar8-container4">
                    <a href="https://www.facebook.com/quyet2004.com" target='_blank'>
                      <div className="navbar8-menu-item1">
                        <img
                          src="/res/facebook_favicon.webp"
                          className="navbar8-page1-image1"
          ...
          <div className="navbar8-icon-group">
            ...
            >
              <a href="https://www.facebook.com/quyet2004" target='_blank'>
...
Navbar8.defaultProps = {
  page4ImageSrc:
    'https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDUyMzk3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  link2Url: 'https://www.teleporthq.io',
  page1Description: undefined,
  page3: undefined,
  linkUrlPage4: 'https://www.teleporthq.io',
  logoAlt: 'Chien C. Lee Logo',
  page1ImageAlt: 'image',
  page3Description: undefined,
  linkUrlPage1: 'https://www.teleporthq.io',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1498050108023-c5249f4df085?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDUyMzk3N3w&ixlib=rb-4.0.3&q=80&w=1080',
  page4ImageAlt: 'image',
  action2: undefined,
  link1: undefined,
  ...
  page2ImageAlt: 'image',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1734594981992-2c09f9b97ac3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDUyMzk3OHw&ixlib=rb-4.0.3&q=80&w=1080',
  page2Description: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1464809064666-ef22abde2569?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDUyMzk3N3w&ixlib=rb-4.0.3&q=80&w=1080',
